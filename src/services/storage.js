...
const CLAVES = { PROGRESO:'hk_progreso', RACHA:'hk_racha', CONFIG:'hk_config' };
...
export const cargarEstadoInicial = async () => {
  const [progreso,racha] = await Promise.all([cargarProgreso(),cargarRacha()]);
