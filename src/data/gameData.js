...
// Todos los datos del juego HébreKids
...
// ── NIVEL 2: Palabras con imagen emoji ───────────────────────────
export const PALABRAS = [
  ...
  { id:11, hebreo:'לָבָן',    español:'Blanco',   emoji:'⬜', categoria:'colores' },
  { id:12, hebreo:'שָׁחוֹר',  español:'Negro',    emoji:'⬛', categoria:'colores' },
  // Familia
  { id:13, hebreo:'אִמָּא',   español:'Mamá',     emoji:'👩', categoria:'familia' },
  { id:14, hebreo:'אַבָּא',   español:'Papá',     emoji:'👨', categoria:'familia' },
  { id:15, hebreo:'אָח',      español:'Hermano',  emoji:'👦', categoria:'familia' },
  { id:16, hebreo:'אָחוֹת',   español:'Hermana',  emoji:'👧', categoria:'familia' },
  // Comida
  { id:17, hebreo:'תַּפּוּחַ', español:'Manzana',  emoji:'🍎', categoria:'comida' },
  { id:18, hebreo:'לֶחֶם',    español:'Pan',      emoji:'🍞', categoria:'comida' },
  { id:19, hebreo:'מַיִם',    español:'Agua',     emoji:'💧', categoria:'comida' },
  { id:20, hebreo:'חָלָב',    español:'Leche',    emoji:'🥛', categoria:'comida' },
];

// ── NIVEL 3: Oraciones para armar ────────────────────────────────
export const ORACIONES = [
  {
    id: 1,
    español: 'Yo quiero agua',
    palabras: ['אֲנִי', 'רוֹצֶה', 'מַיִם'],
    emojis:   ['👤',    '🤲',      '💧'],
  },
  {
    id: 2,
    español: 'Buenos días',
    palabras: ['בֹּקֶר', 'טוֹב'],
    emojis:   ['🌅',     '😊'],
  },
  {
    id: 3,
    español: 'Yo amo a mamá',
    palabras: ['אֲנִי', 'אוֹהֵב', 'אִמָּא'],
    emojis:   ['👤',    '❤️',      '👩'],
  },
  {
    id: 4,
    español: 'El perro es grande',
    palabras: ['הַכֶּלֶב', 'גָּדוֹל'],
    emojis:   ['🐶',       '📏'],
  },
  {
    id: 5,
    español: 'Yo tengo hambre',
    palabras: ['אֲנִי', 'רָעֵב'],
    emojis:   ['👤',    '🍽️'],
  },
  {
    id: 6,
    español: 'La manzana es roja',
    palabras: ['הַתַּפּוּחַ', 'אָדוֹם'],
    emojis:   ['🍎',          '🔴'],
  },
  {
    id: 7,
    español: 'Buenas noches',
    palabras: ['לַיְלָה', 'טוֹב'],
    emojis:   ['🌙',       '😴'],
  },
  {
    id: 8,
    español: 'Muchas gracias',
    palabras: ['תּוֹדָה', 'רַבָּה'],
    emojis:   ['🙏',       '💛'],
  },
];

// ── NIVEL 4: Escenarios interactivos ─────────────────────────────
export const ESCENARIOS = [
  {
    ...
    objetos: [
      { id:'puerta',  emoji:'🚪', hebreo:'דֶּלֶת',   español:'Puerta',   x:0.45, y:0.65 },
      { id:'ventana', emoji:'🪟', hebreo:'חַלּוֹן',   español:'Ventana',  x:0.15, y:0.35 },
      { id:'cama',    emoji:'🛏️', hebreo:'מִיטָּה',   español:'Cama',     x:0.65, y:0.55 },
      { id:'mesa',    emoji:'🪑', hebreo:'כִּסֵּא',   español:'Silla',    x:0.25, y:0.70 },
      { id:'libro',   emoji:'📚', hebreo:'סֵפֶר',     español:'Libro',    x:0.70, y:0.30 },
      { id:'lampara', emoji:'💡', hebreo:'מְנוֹרָה',  español:'Lámpara',  x:0.80, y:0.20 },
    ],
  },
  {
    id: 2,
    ...
    objetos: [
      { id:'arbol',   emoji:'🌳', hebreo:'עֵץ',       español:'Árbol',    x:0.20, y:0.30 },
      { id:'flor',    emoji:'🌸', hebreo:'פֶּרַח',    español:'Flor',     x:0.55, y:0.60 },
      { id:'sol',     emoji:'☀️', hebreo:'שֶׁמֶשׁ',   español:'Sol',      x:0.75, y:0.15 },
      { id:'nube',    emoji:'☁️', hebreo:'עָנָן',     español:'Nube',     x:0.30, y:0.12 },
      { id:'mariposa',emoji:'🦋', hebreo:'פַּרְפַּר', español:'Mariposa', x:0.65, y:0.40 },
  ...
  },
  {
    ...
    objetos: [
      { id:'manzana', emoji:'🍎', hebreo:'תַּפּוּחַ',  español:'Manzana',  x:0.20, y:0.45 },
      { id:'pan',     emoji:'🍞', hebreo:'לֶחֶם',     español:'Pan',      x:0.50, y:0.55 },
      { id:'uva',     emoji:'🍇', hebreo:'עֵנָב',     español:'Uva',      x:0.75, y:0.40 },
      { id:'naranja', emoji:'🍊', hebreo:'תַּפּוּז',   español:'Naranja',  x:0.35, y:0.70 },
      { id:'leche',   emoji:'🥛', hebreo:'חָלָב',     español:'Leche',    x:0.65, y:0.65 },
      { id:'huevo',   emoji:'🥚', hebreo:'בֵּיצָה',   español:'Huevo',    x:0.15, y:0.70 },
    ],
  },
];
